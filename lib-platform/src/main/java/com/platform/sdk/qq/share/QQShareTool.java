package com.platform.sdk.qq.share;
...
public class QQShareTool {
    ...
    public QQShareTool() {
        ...
        ConfigEntity entity = PlatformConfigurator.getInstance().getConfiguration(PlatformType.QQ);
...
//        params.putInt(QQShare.SHARE_TO_QQ_EXT_INT, QQShare.SHARE_TO_QQ_FLAG_QZONE_AUTO_OPEN);
    ...
    private IUiListener mIUiListener = new IUiListener() {
        ...
        public void onError(UiError uiError) {
            ShareObservable.getInstance().publishFailed(PlatformType.QQ, uiError.errorMessage);
        }
