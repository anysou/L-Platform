...
public class ShareChannelAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    private List<ShareChannelBean> mData;
    private int mItemPadding;
    private OnChannelClickListener mChannelClickListener;

    public ShareChannelAdapter(Context context, List<ShareChannelBean> data, OnChannelClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        final ShareChannelBean itemData = mData.get(position);
    ...
    public void onClick(View v) {
        ShareChannelBean bean = (ShareChannelBean) v.getTag();
    ...
    public interface OnChannelClickListener {
        void onClick(ShareChannelBean channelBean);
    }
}
