...
import com.lu.platform.sdk.alipay.sdk.pay.PayResult;
import com.lu.platform.sdk.alipay.sdk.pay.util.OrderInfoUtil2_0;
...
//                    String resultInfo = payResult.getResult();// 同步返回需要验证的信息
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        PayObservable.getInstance().publishSuccess(Constants.ALI, "支付成功");
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        PayObservable.getInstance().publishFailed(Constants.ALI, "支付失败");
                    }
                    break;
                default:
                    break;
