...
public class WXPrePayUtil {
    ...
    //统一下单成功返回数据后发起支付请求
    private PHttpCallback callback = new PHttpCallback() {
        @Override
        public void onSuccess(String data) {
            ...
            if (resultCode.equals("SUCCESS")) {
                ...
                PayObservable.getInstance().publishFailed(Constants.WEIXIN, "生成预支付订单出错");
            }
        }

        @Override
        public void onError(String errorMessage) {
            PayObservable.getInstance().publishFailed(Constants.WEIXIN, "统一下单网络请求失败");
        }
    };
    ...
    public void startPrePay() {
        ...
        //发起预支付请求
        new PHttpUtil().post(WX_UNIFIED_ORDER, orderInfo, callback);
    }
